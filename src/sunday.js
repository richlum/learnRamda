...
console.log('xprod',R.xprod(list1,list2))

const pred = R.converge(R.eqProps('name'),[R.head,R.last])
console.log ('pred',pred([list1[0],list2[0]]))
console.log('identity1', R.identity(list1[0]))
console.log('identity2', R.identity(list2[0]))
console.log('refmerge', R.merge(list1[0],list2[0]))
const logme = R.curry((tag,data) => console.log( tag, data) )
const loggedIdentity = R.compose (R.identity,R.tap(logme('id')))
console.log('expose', R.converge(R.compose(R.merge,R.tap(logme('mergeAllInput'))), [R.head,R.last])([list1[0],list2[0]]))
//console.log('expose', R.converge(R.mergeAll, [R.identity,R.identity])([list1[0],list2[0]]))
/*
